...
namespace CCmall.Repository.Interface
{
    public interface IBaseRepository<TEntity> where TEntity : class, new()
    {
        ...
        Task<PageModel<TEntity>> QueryPage(Expression<Func<TEntity, bool>> whereExpression, string strOrderByFileds, bool Isdesc = true, int intPageIndex = 1, int intPageSize = 20);
